...
export const Hero = () => {
  return (
    <div className="mx-6 mt-4 pt-36 border bg-orange-200 rounded-t-2xl flex-col pl-[400px] pr-[256px] pb-2">
      ...
      <div className="flex justify-end pt-2 gap-2 items-end">
        <input
          type="text"
          placeholder="Enter your email"
          className="bg-orange-300 rounded gap-1 px-2 py-1 text-sm w-auto placeholder:text-[#2b4149]/40 focus:outline-none"
        />
        <button className="p-1 text-sm flex gap-1 items-center shadow bg-stone-50 rounded">
          Get Demo
          <FaArrowRight />
        </button>
      </div>
